...
public class ManaSweepParticleData implements ParticleProvider<ColorParticleTypeData> {
    ...
    public static ParticleOptions createData(ParticleColor color) {
        return new ColorParticleTypeData(ParticleSetup.MANA_SWEEP_TYPE.get(), color, false);
    }

    public static ParticleOptions createData(ParticleColor color, boolean disableDepthTest, float size) {
        return new ColorParticleTypeData(ParticleSetup.MANA_SWEEP_TYPE.get(), color, disableDepthTest, size, 0.75f, 36);
    }
