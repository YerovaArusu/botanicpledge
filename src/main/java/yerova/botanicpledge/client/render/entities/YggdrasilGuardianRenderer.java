...
public class YggdrasilGuardianRenderer extends HumanoidMobRenderer<YggdrasilGuardian, HumanoidModel<YggdrasilGuardian>> {
	...
	public YggdrasilGuardianRenderer(EntityRendererProvider.Context ctx) {
	...
	@Override
	public void render(@NotNull YggdrasilGuardian dopple, float yaw, float partialTicks, PoseStack ms, MultiBufferSource buffers, int light) {
	...
	@NotNull
	@Override
	public ResourceLocation getTextureLocation(@NotNull YggdrasilGuardian entity) {
	...
	@Override
	protected boolean isBodyVisible(YggdrasilGuardian dopple) {
		return true;
	}

	private static class Model extends HumanoidModel<YggdrasilGuardian> {
